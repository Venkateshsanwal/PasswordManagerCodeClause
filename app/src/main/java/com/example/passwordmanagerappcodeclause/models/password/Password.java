package com.example.passwordmanagerappcodeclause.models.password;
...
public class Password {
    ...
    public static Password fromCursor(Cursor cursor) {
        ...
        password.updateDate=new Date(Long.parseLong(cursor.getString(cursor.getColumnIndex("updateDate"))));
    ...
    public ContentValues getContentValues() {
        ...
        //values.put("updateDAte",updateDate.getTime());
